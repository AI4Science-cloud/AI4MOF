...
plt.text(0.75, 0.18, '$R^2$   0.7673   0.5912   0.5788', transform=plt.gca().transAxes,  
         fontsize=14, fontname = 'Times New Roman', va='top', ha='center')  
plt.text(0.72, 0.09, '$RMSE$   13.8608  18.7742 19.6898', transform=plt.gca().transAxes,  
         fontsize=14, fontname = 'Times New Roman', va='top', ha='center')  
...
plt.savefig('CGCNN_selectivity.png', dpi=300)
