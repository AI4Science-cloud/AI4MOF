...
csv_files = ["MEGNet_my_train_job_train_outputs.csv", "MEGNet_my_train_job_val_outputs.csv", "MEGNet_my_train_job_test_outputs.csv"]  # 这里替换为你的CSV文件名  
...
# 添加黑色加粗字体的小标签  
plt.text(0.165, 0.97, 'MEGNet', transform=plt.gca().transAxes,  
         fontsize=14, fontweight='bold', va='top', ha='center')  
plt.text(0.79, 0.25, 'Train      Val        Test', transform=plt.gca().transAxes,  
         fontsize=14, fontname = 'Times New Roman', va='top', ha='center')  
plt.text(0.75, 0.18, '$R^2$    0.9361   0.9257   0.9357', transform=plt.gca().transAxes,  
         fontsize=14, fontname = 'Times New Roman', va='top', ha='center')  
plt.text(0.72, 0.09, '$RMSE$   0.2849   0.3356   0.2973', transform=plt.gca().transAxes,  
         fontsize=14, fontname = 'Times New Roman', va='top', ha='center')  
