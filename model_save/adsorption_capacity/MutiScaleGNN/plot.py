...
csv_files = ["my_train_job_train_outputs.csv", "my_train_job_val_outputs.csv", "my_train_job_test_outputs.csv"]  # 这里替换为你的CSV文件名  
...
plt.text(0.75, 0.18, '$R^2$ 0.9419   0.9515   0.9423', transform=plt.gca().transAxes,  
         fontsize=14, fontname = 'Times New Roman', va='top', ha='center')  
plt.text(0.72, 0.09, '$RMSE$ 0.2713   0.2632   0.2829', transform=plt.gca().transAxes,  
         fontsize=14, fontname = 'Times New Roman', va='top', ha='center')  
...
plt.savefig('MultiScaleGNN_adsorption.png', dpi=300)
