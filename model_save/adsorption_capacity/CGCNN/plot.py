...
csv_files = ["CGCNN_my_train_job_train_outputs.csv", "CGCNN_my_train_job_val_outputs.csv", "CGCNN_my_train_job_test_outputs.csv"]  # 这里替换为你的CSV文件名  
...
# 添加黑色加粗字体的小标签  
plt.text(0.165, 0.97, 'CGCNN', transform=plt.gca().transAxes,  
