...
def get_dataset(data_path, target_index, reprocess="False", processing_args=None):
    if processing_args == None:
        processed_path = "processed_Multi_adsorption_pre"
    else:
        processed_path = processing_args.get("processed_path", "processed_Multi_adsorption_pre")
...
def process_data(data_path, processed_path, processing_args):
    ...
    for index in range(0, len(target_data)):
        ...
        if index == 0:
            ...
            #print(len(ase_crystal))
        #print(sum(elements,[]))
        #print(list(set(sum(elements, []))))#list(set(sum(elements, [])))
        ...
        #print(data.edge_descriptor["distance"].size())
        # print(data.edge_descriptor["distance"])
        # print(data.edge_descriptor["mask"].size())
        # print(data.edge_descriptor["mask"])
        # print('END')
        ...
        if if_adsorption=="True":
            #print("is adsorption")
            data_1=Data()
            data_1.ase = ase_crystal
            data_1.edge_index = edge_index
            data_1.edge_weight = edge_weight
            data_1.edge_descriptor = {}
            data_1.edge_descriptor["distance"] = edge_weight
            data_1.edge_descriptor["mask"] = distance_matrix_mask
            ...
            data_2=Data()
            data_2.ase = ase_crystal
            data_2.edge_index = edge_index
            data_2.edge_weight = edge_weight
            data_2.edge_descriptor = {}
            data_2.edge_descriptor["distance"] = edge_weight
            data_2.edge_descriptor["mask"] = distance_matrix_mask
            ...
            data_3=Data()
            data_3.ase = ase_crystal
            data_3.edge_index = edge_index
            data_3.edge_weight = edge_weight
            data_3.edge_descriptor = {}
            data_3.edge_descriptor["distance"] = edge_weight
            data_3.edge_descriptor["mask"] = distance_matrix_mask
            ...
            #print(data_1.parametres[1])
            #print(data_2.parametres[1])
            #print(data_3.parametres[1])
        else:
    ...
    if processing_args["dictionary_source"] != "generated":
        ...
        #print(atom_fea)
        #print(data_list[index].x.size())[228,100]
    ...
    #print(data_list[index].x.size())[228,114]
    ...
    # print("data.num_edge_features:", data.num_edge_features)50
    # print("data.num_features:", data.num_features)114
...
class GaussianSmearing(torch.nn.Module):
    ...
    def forward(self, dist):
        #unsqueeze(-1) add the last dimention
