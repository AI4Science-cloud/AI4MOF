...
from MOF_graph.process.atoms import Atoms
##torch imports
import torch
...
def process_data(data_path, processed_path, processing_args):
    ...
    ##Load dictionary
    #E:\MOF_design\MOF_design\MOF_graph\MOF_graph\process\dictionary_default.json
...
def get_node_LJ(s):
    with open(r'E:\MOF_design\MOF_design\MOF_graph\MOF_graph\process\LJ.json','r') as file:
        data_LJ = file.read()
