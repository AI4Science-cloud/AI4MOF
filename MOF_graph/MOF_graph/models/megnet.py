    ...
    def __init__(
        ...
        **kwargs
        ...
        for i in range(gc_count):
            if i == 0:
                e_embed = Sequential(
                    Linear(num_edge_features, dim3), ReLU(), Linear(dim3, dim3), ReLU()
                )
                x_embed = Sequential(
    ...
    def forward(self, data):
        ...
        if self.pool_order == "early":
            if self.pool == "set2set":
                ...
                e_pool = scatter(e, edge_index[0, :], dim=0, reduce=self.pool_reduce)
